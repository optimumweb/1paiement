...
function enqueue() {
	if ( !is_admin() ) {
		...
		// styles
		wp_enqueue_style('google-fonts', "https://fonts.googleapis.com/css?family=Merriweather+Sans:300,300i,400,400i,700,700i|Roboto:300,300i,400,400i,700,700i|Scope+One");
